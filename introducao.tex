...
On the other end of the spectrum, there are scientists enlisting amateurs to contribute on Citizen Science initiatives. With the rise in interest from the public, they are able to achieve otherwise impossible results. % give some examples
...
This work identifies the Citizen Science practice as a potential candidate to create a robust Speech Corpus through 
