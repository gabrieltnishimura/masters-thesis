...
In the figure \ref{fig:app-nsu-example}, the navigation behavior to record a phrase of a unregistered user is illustrated. As the unregistered user enters the homepage, he clicks the start recording button. However, since he has neither accepted the terms of service nor enabled his microphone permissions, he must go through these pages. If he denies the terms or the microphone permissions, he is redirected to the homepage. If the user allows both, he will enter the recording page, where he is able to record phrases and donate his voice.
...
\subsubsection{Navigation Syntax}

The mechanics of navigation are defined by elements such as:
...
Refer to the implementation of these elements on the user interface section \ref{sec:app-user-interface}.
