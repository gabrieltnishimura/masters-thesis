...
Finally, to identify the characteristics of a speech corpus, a systematic literature was performed \cite{kitchenham2009systematic}.
...
\label{tab:results-categorization}
    \hline 
    Authors & Application area & Context & Language \\ \hline
